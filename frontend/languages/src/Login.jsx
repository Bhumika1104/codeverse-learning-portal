...
// function Login({ setLoggedInUser, goToRegister, goToForgot }) {
...
//       <p>
//         New user? <button onClick={goToRegister}>Register</button>
//       </p>
  ...
  <div className="flex items-center gap-12 h-full">
    ...
    <div className="flex-1 text-white">
      ...
      <div className="grid grid-cols-4 gap-6">
        ...
        {/* RIGHT LOGIN CARD (SAME DESIGN AS REGISTER) */}
        <div className="w-2/5 flex items-center justify-center">
           ...
           */}
           <div className="w-[500px] p-12 rounded-3xl border border-purple-500 bg-black/70 shadow-[0_0_50px_rgba(255,0,255,0.8)] backdrop-blur-lg min-h-[520px] flex flex-col justify-center">
